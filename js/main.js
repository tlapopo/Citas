...
let db = prodb("Productdb", {
  products: `++id, name, seller, mail, adi, price`
});
...
const adic = document.getElementById("adi");
...
btncreate.onclick = event => {
  ...
  //seller.value = "";
  // price.value = "";
  proname.value = seller.value = mail.value= adi.value= price.value = "";
